...
>
    <div>
        ...
        <div class="h-16 px-6 flex items-center justify-between border-b border-slate-800/80">
            <a href="{{ route('dashboard.index', ['role' => $role]) }}" class="flex items-center gap-3 group">
        ...
        <nav class="px-3 py-4 space-y-1.5 overflow-y-auto max-h-[calc(100vh-210px)]">
            ...
            <!-- Dashboard -->
            <a
                href="{{ route('dashboard.index', ['role' => $role]) }}"
            ...
            <!-- Pemasukan -->
            <a
                href="{{ route('pemasukan.index', ['role' => $role]) }}"
            ...
            <!-- Pengeluaran -->
            <a
                href="{{ route('pengeluaran.index', ['role' => $role]) }}"
